...
<!-- jQuery -->
		...
		<script src="<?php echo esc_url(get_template_directory_uri()); ?>/js/cbpAnimatedHeader.js"></script>
		...
		<script src="<?php echo esc_url(get_template_directory_uri()); ?>/js/agency.js"></script>
